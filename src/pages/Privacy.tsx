                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    {language === 'de' 
                      ...
                      : 'The owners of this website take the protection of your personal data very seriously. We handle your personal data confidentially and in accordance with the relevant data protection regulations and this privacy policy.'
                    }
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    {language === 'de' 
                      ...
                      : 'The provider of the website automatically collects and stores information in so-called server log files, which your browser sends to us. These include:'
                    }
                  </p>
                  ...
                  <p className="text-sm leading-relaxed mt-2">
                    {language === 'de' 
                      ...
                      : 'The collection of these data is not combined with other data sources. The collection of these data is based on Art. 6 para. 1 lit. f of the DSGVO.'
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <p className="text-sm leading-relaxed">
                  {language === 'de' 
                    ...
                    : 'You have the right to obtain free information about the origin, recipient, and purpose of your stored personal data. You also have the right to request the correction or deletion of this data.'
                  }
                </p>
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    {language === 'de' 
                      ...
                      : 'If you have questions about data protection, please write us an email or contact the responsible person for data protection in our organization:'
                    }
                  </p>
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    {language === 'de' 
                      ...
                      : 'This website is hosted by an external service provider (host). The personal data collected on this website is stored on the servers of the host. This includes IP addresses, contact requests, meta and communication data, contract data, contact data, names, website accesses, and other data generated by a website.'
                    }
                  </p>
                </div>
              </div>
